...
export const TRANSLATIONS = {
  'pt-BR': {
    ...
    'admin.stage_trans_title': '🎬 Transições & Ritmo do Palco',
    'admin.trans_mode_label': 'Ritmo das Transições:',
    'admin.trans_mode_deck': '🎯 Seguir Autoria do Deck (Padrão)',
    'admin.trans_mode_fast': '⚡ Forçar Modo Rápido (350ms)',
    'admin.trans_mode_smooth': '✨ Forçar Modo Suave (600ms)',
    'admin.trans_mode_cinema': '🎬 Forçar Cinematográfico (950ms)',
    'admin.trans_mode_epic': '🌌 Forçar Modo Épico (1400ms)',
    'admin.trans_mode_custom': '🎛️ Ajuste Manual (Slider)',
    'admin.trans_effect_label': 'Efeito de Transição:',
    'admin.trans_effect_deck': '🌐 Seguir Efeito do Slide/Deck',
    'admin.trans_fade': '✨ Fade Suave',
    'admin.trans_slide': '↔️ Slide 3D',
    'admin.trans_zoom': '🔍 Zoom Dinâmico',
    'admin.trans_dissolve': '🌫️ Dissolve Cinematográfico',
    'admin.trans_stagger': '📶 Cascata (Stagger)',
    'admin.btn_test_trans': '👁️ Testar',
    'import.cfg_transition_speed': 'Velocidade Padrão',
    'import.slide_speed_label': 'Velocidade:',
    'import.speed_inherit': '🌐 Herdar Global',
    'import.speed_fast': '⚡ 350ms (Rápido)',
    'import.speed_smooth': '✨ 600ms (Suave)',
    'import.speed_cinema': '🎬 950ms (Cinema)',
    'import.speed_epic': '🌌 1400ms (Épico)',
  ...
  'en-US': {
    ...
    'admin.stage_trans_title': '🎬 Stage Transitions & Pacing',
    'admin.trans_mode_label': 'Transition Pacing:',
    'admin.trans_mode_deck': '🎯 Follow Deck Authoring (Default)',
    'admin.trans_mode_fast': '⚡ Force Fast Mode (350ms)',
    'admin.trans_mode_smooth': '✨ Force Smooth Mode (600ms)',
    'admin.trans_mode_cinema': '🎬 Force Cinema Mode (950ms)',
    'admin.trans_mode_epic': '🌌 Force Epic Mode (1400ms)',
    'admin.trans_mode_custom': '🎛️ Manual Adjustment (Slider)',
    'admin.trans_effect_label': 'Transition Effect:',
    'admin.trans_effect_deck': '🌐 Follow Slide/Deck Effect',
    'admin.trans_fade': '✨ Smooth Fade',
    'admin.trans_slide': '↔️ 3D Slide',
    'admin.trans_zoom': '🔍 Dynamic Zoom',
    'admin.trans_dissolve': '🌫️ Cinema Dissolve',
    'admin.trans_stagger': '📶 Stagger Cascade',
    'admin.btn_test_trans': '👁️ Test',
    'import.cfg_transition_speed': 'Default Speed',
    'import.slide_speed_label': 'Speed:',
    'import.speed_inherit': '🌐 Inherit Global',
    'import.speed_fast': '⚡ 350ms (Fast)',
    'import.speed_smooth': '✨ 600ms (Smooth)',
    'import.speed_cinema': '🎬 950ms (Cinema)',
    'import.speed_epic': '🌌 1400ms (Epic)',
